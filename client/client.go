...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string) *ecs.ECS {
	...
	clusterClient := ecs.New(awsSession)
